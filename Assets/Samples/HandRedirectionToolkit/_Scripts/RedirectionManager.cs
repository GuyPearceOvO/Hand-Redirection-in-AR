...
namespace HR_Toolkit
{
    public class RedirectionManager : MonoBehaviour
    {
        ...
        [Header("Input")]
        [SerializeField] private OVRInput.Button advanceTargetButton = OVRInput.Button.One;
        [SerializeField] private OVRInput.Button alternateAdvanceTargetButton = OVRInput.Button.None;
        ...
        private void CheckForNewTarget()
        {
            ...
            if (!advance)
            {
                if (OVRInput.GetDown(advanceTargetButton))
                {
                    advance = true;
                }
                else if (alternateAdvanceTargetButton != OVRInput.Button.None &&
                         OVRInput.GetDown(alternateAdvanceTargetButton))
                {
                    advance = true;
                }
            }
            ...
            if (target != null)
            {
                if (!target.thisIsAResetPosition)
                {
                    ...
                    // current is resetPosition: keep the index of the lastTarget and dont override it
                    lastTarget = target;
                }
