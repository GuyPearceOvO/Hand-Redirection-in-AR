...
public class MovementController : MonoBehaviour
{
    ...
    public void MoveHand()
    {
        ...
        if (Application.isPlaying && Time.frameCount % 120 == 0)
        {
            Debug.Log($"[MovementController] mode={currentMovement}, tracked={(trackedHand ? trackedHand.name : "null")}, realHand={(realHand ? realHand.name : "null")}");
        }
        switch (currentMovement)
        {
            ...
            case Movement.VR:
                ...
                if (trackedHand != null && realHand != null)
                {
