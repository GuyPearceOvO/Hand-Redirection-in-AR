...
namespace HRTK.MaskedRetargeting
{
    public class MaskRig : MonoBehaviour
    {
        ...
        public Camera MaskCamera => maskCamera;
        public MeshRenderer OutputQuad => outputQuad;
        public MeshRenderer OutlineQuad => outlineQuad;
        public RenderTexture OutputTexture => maskCamera != null ? maskCamera.targetTexture : outputTexture;
