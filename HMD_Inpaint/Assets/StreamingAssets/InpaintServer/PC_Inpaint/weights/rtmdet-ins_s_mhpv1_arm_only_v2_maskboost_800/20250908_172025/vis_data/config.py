...
custom_hooks = [
    ...
    dict(
        out_dir='debug\\hand_runner_only4_800',
        save_bbox=False,
        save_mask=True,
        score_thr=0.05,
        stats_file='debug\\hand_runner_only4_800\\stats.txt',
        type='MaskDumpHook'),
]
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='debug\\hand_runner_only4_800\\_tmp_ann.json',
        data_prefix=dict(img='C:\\Users\\39241\\RTMDet_Test\\inputs\\Hand'),
        data_root='',
